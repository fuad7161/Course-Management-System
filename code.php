...
if(isset($_POST['upload_question']))
{
    ...
    $pdf = mysqli_real_escape_string($con,$_FILES['pdf']['name']);
    $pdf_type = mysqli_real_escape_string($con,$_FILES['pdf']['type']);
    $pdf_size = mysqli_real_escape_string($con,$_FILES['pdf']['size']);
    $pdf_tem_loc = mysqli_real_escape_string($con , $_FILES['pdf']['tem_name']);
    $pdf_stroe="pdf/".$pdf;
